...
The manual translation workflow typically involves several steps, illustrated in Figure \ref{fig:manual_workflow}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/manual-process.drawio.png}
