...
Average Precision (AP) is computed as the area under the precision--recall curve. mAP\@50 denotes the mean AP at an IoU threshold of 0.50, while $mAP@[0.5:0.95]$ averages AP over IoU thresholds from 0.50 to 0.95 with a step size of 0.05.