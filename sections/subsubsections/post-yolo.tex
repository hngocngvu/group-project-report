Although YOLO gives a a pixel-precise mask for every panel, it still returns *one* mask when two, three or more balloons touch or overlap. Feeding such a merged region to an OCR engine makes the text layout denser and usually causes a noticeable drop in recognition accuracy.
