...
For Japanese-to-English translation evaluation, we use COMETScore \cite{rei2022comet} and BERTScore \cite{zhang2020bertscore} as the primary metrics, with chrF \cite{popovic2015chrf} and chrF++ \cite{popovic2017chrf++} as additional metrics for reference.
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item $\beta$: controls the weight given to recall versus precision; typically $\beta=2$ is used (called chrF++) to emphasize recall
    \end{itemize}
\end{enumerate}