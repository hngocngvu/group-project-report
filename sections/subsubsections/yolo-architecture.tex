...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{img/C2PSA.pdf}
        \caption{C2PSA module}
    \end{subfigure}
    \hspace{-1.5em}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=0.9\linewidth]{img/PSABlock.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=0.95\linewidth]{img/C2f.pdf}
        \caption{C2f module}
    \end{subfigure}
    \hspace{-1.5em}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=0.9\linewidth]{img/C3k2.pdf}
...
\end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{img/YOLACT.pdf}
