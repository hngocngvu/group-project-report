For Japanese-to-English translation evaluation, we use BERTScore \cite{zhang2020bertscore} and COMETScore \cite{rei2022comet} as the primary metrics, with chrF \cite{popovic2015chrf} and $chrF++$ \cite{popovic-2017-chrf} as additional metrics for reference.\\
\vspace{2em}
